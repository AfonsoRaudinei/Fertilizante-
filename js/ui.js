      ...
      .map(
        ...
        <article class="fert-card ${fert.active ? "" : "fert-card--inactive"}" data-index="${index}">
          <div class="fert-content">
            ...
            <p class="fert-sub fert-sub--compact">${formula(fert)} <span class="price-badge">${compactMoneyTon(fert.price)}</span></p>
            <p class="fert-sub fert-sub--date">${formatRelativeDate(fert.lastPriceUpdate)}</p>
